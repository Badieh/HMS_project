...
class AppRoutes {
  ...
  static const doctorFollowUpScreen = Routes.doctorFollowUpScreen;
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.doctorFollowUpScreen,
      page: () => DoctorFollowUpScreen(),
    ),
  ];
}
...
class Routes {
  ...
  static const doctorFollowUpScreen = '/doctorFollowUpScreen';
}
